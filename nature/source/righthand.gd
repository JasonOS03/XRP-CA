...
func _ready() -> void:
	...
	pointer.active_button_action = "godot/ax_button" # set the active button to be the ax_button, the right hand controller uses a

	# connect the on_pointer_event function with the pointer using a signal
